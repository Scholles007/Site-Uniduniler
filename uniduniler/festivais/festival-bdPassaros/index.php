...
<div class="container">
    <div class="row">
        <div class="col-md-7 letra">
            ...
            <img class="fesl" src="../../dist/img/festivalit.png" alt="Festival itinerante de leitura">
            <img src="../../dist/img/passarinho20.png" alt="Imagem de um passarinho desenhado" class="b1 img-fluid">
        </div>
        <div class="col-md-5">
            <div class="row">
                <div class="col-md-12">
