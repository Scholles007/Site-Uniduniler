    ...
    <div class="carousel-item active">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    <p><br></p>
                    <img src="../dist/img/Slide1.1-Carro(Meio).png" class="img-fluid" style="max-width:100%;" alt="First slide"><br>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 col-sm-2" >
                    <img src="../dist/img/slide-texto1.1(esquerda).png" style="object-fit: contain;" >
                </div>
                <div class="col-md-7 col-sm-7">
                    <div class="row"><img src="../dist/img/slide-texto1.1(meio).png"style="object-fit: contain;"></div>
                    <div class="row"><div class="texto79">
                        <p class="poppinsextra record" style="text-align: center;">
                            ...
                            divididos toda semana com famílias numa creche em Brasília.<br><br><br><br> <!--Pesquisar o substitudo de br, um que sobe o texto-->
                        </p>
                    </div></div>
                </div>
                <div class="col-md-2 col-sm-2">
                    <img src="../dist/img/slide-texto1.1(direita).png" style="object-fit: contain;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="carousel-item">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row"><img src="../dist/img/slide-texto2.2(topo).png"style="object-fit: contain;"></div>
                    ...
                    <div class="row">
                        <div class="col-md-2"><img src="../dist/img/slide-texto2(fundo)(esquerda).png"style="object-fit: cover;" ></div>
                        <div class="col-md-8"></div>
                        <div class="col-md-2"><img src="../dist/img/slide-texto2(fundo)(direita).png"style="object-fit: cover;"></div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-2"><img src="../dist/img/slide-texto3(fundo)(esquerda).png" style="object-fit: cover;"></div>
                        <div class="col-md-8"></div>
                        <div class="col-md-2"><img src="../dist/img/slide-texto3(fundo)(direita).png" style="object-fit: cover;"></div>
                </div>
                 <div class="col-md-2">
                </div>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="texto79">
                        <h4><p class="poppinsextra" style="text-align: center;">
                            <br><br><br>
                           Agora, o Festival Intinerante de Leitura do Uniduniler  se prepara para a quinta edição, contemplado mais uma vez<br><br><br> pelo FAC  - <span class="marmalade mm2">Fundo de Apoio à Cultura do Distrito Federal (FAC-DF)</span>.<br><br>
                        </p></h4>
                    </div></div>
                    <div class="row">
                        <div class="col-md-2"><img src="../dist/img/slide-texto4(fundo)(direita).png" style="object-fit: contain;"></div>
                        <div class="col-md-10"><img src="../dist/img/slide-texto4(fundo)(esquerda).png" style="object-fit: cover;"></div>
                </div>
            </div>
            <div class="col-md-2">
            </div>
...
<div class="container"> 
    ...
    <div  class="atleft">
        <div class="row">
            <div class="col-sm-4">
                <a href="../atividades/#aletramento"><img src="../dist/img/Aletramento.png" class="img-fluid"></a>
            </div>
            <div class="col-sm-4">
...
<div class="container">             
    <div class="row"><img src="../dist/img/o-festival.png" class="img-fluid"></div>
</div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row"><img src="../dist/img/festival1-escuro.png" style="max-width:100%;"></div>
                            <div class="row">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row"><img src="../dist/img/festival2-escuro.png" style="max-width:100%;"></div>
                            <div class="row">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row"><img src="../dist/img/festival3-escuro.png" style="max-width:100%;"></div>
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="texto79">
...
<!-- Final do Carrossel 3 -->

<div class="container">             
    <div class="row">
    <img src="../dist/img/fest-int1.png" class="img-fluid"style="object-fit: contain; padding-left: 10%"> 
    </div>
</div>
