...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Atividades
      <small>Adicione atividades ao site!</small>
    </h1>
  </section>
    <!-- Main content -->
  ...
  <div class="box-body">
    ...
    <table id="tabela" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        //$objDb = new db();
        //$link = $objDb->conecta_mysql();
        $sqls = " SELECT * FROM atividades_geral";
        ...
        if($resultado_ids){
          while($registros = mysqli_fetch_array($resultado_ids, MYSQLI_ASSOC)){
              ...
              <td class="mailbox-name">
                <a data-toggle="modal" data-target="#ModalLer"><?php echo $registros['Titulo']; echo $registros['subtitulo']?></a>
              </td>
              <td class="mailbox-subject"><?php echo $registros['Descrição']?></td>
                  <div class="item_lista">
                    <?php echo "<td><a href='atividades/edit_page.php?id=$numero'><div class='item_lista'><span class='fa fa-edit item_lista'></span>
                                    </div></a></td>";?>
                  </div>
              <td>
                <a>
  ...
  <div id="ModalAdicionar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="atividades/add_atividade.php" method="POST" enctype="multipart/form-data"> <!--faz o post para o arquivo php-->
          <div class="modal-body">
          <br>
          <div class="form-group">
            <label>Título</label>
            <input type="text" name="titulo" class="form-control" placeholder="O título da atividade."
                  required minlength="3"></br>
            <input type="text" name="subtitulo" class="form-control" placeholder="O subtítulo da atividade."
                  required minlength="3">
            </div>
            <div class="form-group">
                <label>Descrição</label>
                <textarea name="descricao1" class="form-control" rows="3" placeholder="Conte sobre a atividade"
                required minlength="50"></textarea>
            </div>
            <div class="form-group">
                <label>Oficina 1</label>
                <input type="text" name="titulo1" class="form-control" placeholder="Titulo"></br>
                <input type="text" name="duracao1" class="form-control" placeholder="Duração"></br>
                <input type="text" name="publico1" class="form-control" placeholder="Público"></br>
                <input type="text" name="necessidade1" class="form-control" placeholder="Necessidade"></br>
                <input type="text" name="link1" class="form-control" placeholder="Link do Youtube"></br>
            </div>
            <div class="form-group">
                <label>Oficina 2</label>
                <input type="text" name="titulo2" class="form-control" placeholder="Titulo"></br>
                <input type="text" name="duracao2" class="form-control" placeholder="Duração"></br>
                <input type="text" name="publico2" class="form-control" placeholder="Público"></br>
                <input type="text" name="necessidade2" class="form-control" placeholder="Necessidade"></br>
                <input type="text" name="link2" class="form-control" placeholder="Link do Youtube"></br>
            </div>
            <div class="form-group">
                <label>Oficina 3</label>
                <input type="text" name="titulo3" class="form-control" placeholder="Titulo"></br>
                <input type="text" name="duracao3" class="form-control" placeholder="Duração"></br>
                <input type="text" name="publico3" class="form-control" placeholder="Público"></br>
                <input type="text" name="necessidade3" class="form-control" placeholder="Necessidade"></br>
                <input type="text" name="link3" class="form-control" placeholder="Link do Youtube"></br>
            </div>
            ...
            <div class="form-group">
                    <label for="InputFile">Imagens para a Atividade</label>
  ...
  <div id="ModalApagar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="atividades/rmv_atividades.php" method="POST" enctype="multipart/form-data"> <!--faz o post para o arquivo php-->
          <div class="modal-body">
