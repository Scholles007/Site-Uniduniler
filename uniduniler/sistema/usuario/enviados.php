...
<?php
  ...
  $sqls = " SELECT * FROM mensagens where Nome = $nomes";
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="mensagens.php"><i class="fa fa-inbox"></i> Caixa de Entrada
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <?php
                        ...
                        $objDb = new db();
                        $link = $objDb->conecta_mysql();
                        $sqls = " SELECT * FROM mensagens_resposta WHERE Nome = '{$_SESSION['Email']}' ORDER BY ID DESC";
                        $resultado_ids = mysqli_query($link, $sqls);
                        if($resultado_id){
                        while($registros = mysqli_fetch_array($resultado_ids, MYSQLI_ASSOC)){
                            ...
                            $mensagem = $registros['Mensagem']?>
                              ...
                              <td class="mailbox-name">
                                <a data-toggle="modal" data-target="#ModalLer"><?php echo $registros['Email'] ?></a>
                              </td>
                    ...
                    <div id="ModalApagar" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="../usuario/mensagens/remove_message_sent.php" method="POST" enctype="multipart/form-data"> <!--faz o post para o arquivo php-->
              ...
              <div id="mensagens" class="list-group"></div>
