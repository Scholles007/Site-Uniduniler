      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
          <form action="editar_atualidade.php?id=<?php echo $id?>"  method="POST" name="upload_form" id="upload_form" enctype="multipart/form-data">
          <?php
              require_once('../db.class.php');
              $objDb = new Db();
              $link = $objDb->conecta_mysql();
              ...
              echo "<input type='text' name='data' class='form-control' maxlength='10' placeholder='dd/mm/aaaa' onKeyPress='DataHora(event, this)' value = '$data'>";
              echo "</div>";
              echo "<br>";
              echo "<div class='form-group'>";
              echo "<label>Título</label>";
              echo "<input type='text' name='titulo' class='form-control' placeholder='O título da notícia.'
                      required minlength='10' value = '$titulo'>";
              echo "</div>";
              echo "<div class='alert alert-success' role='alert'>Ao editar essa página, lembre-se de retirar as aspas simples da Postagem!
                <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>
                //&times;</span></button></div>";
              echo "<div class='form-group'>";
              echo "<label>Postagem</label>";
              echo "<textarea name='postagem' class='form-control' rows='3' placeholder='O que aconteceu?'
                    required minlength='200'>'$post'</textarea>";
              echo "</div>";
              echo "<div class='form-group'>";
              echo "<label>Endereço</label>";
              echo "<input type='text' name='link1' class='form-control' placeholder='Link para a notícia'
                      minlength='10' required value='$link'>";
              echo "</div>";
              }
        ...
        <table id="tabela" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        $objDb = new db();
                        $link = $objDb->conecta_mysql();
                        $sqls = " SELECT * FROM atualidades_galeria where ID_atualidades = $id";
