...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php">Alterar Senha</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <!-- Form  de login (Espaços preenchidos de enfeite) -->
    <form  method="post" action="altera.php?id=<?php echo $nome?>" id="formLogin">
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Senha Atual" name="atual" required>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Nova Senha" name="nova" required>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
      <div class="col-xs-8">
          <button type="submit" class="btn btn-primary btn-block btn-flat" style="margin-left:50px;">Alterar</button><center><br>
        </div>
      </div>
    </form>
  </div>
