    ...
    <script>
      $(document).ready(function(){
                ...
                function atualizaNoticias(){
                    $.ajax({
                        url: '../../sistema/adiciona_festival/adiciona_noticias.php?id=<?php echo $_GET["id"]?>',
                        success: function(data){
                            $('#pega_noticias').html(data);
                ...
                function atualizaProgramação(){
                    $.ajax({
                        url: '../../sistema/adiciona_festival/adiciona_programação.php?id=<?php echo $_GET["id"]?>',
                        success: function(data){
                            $('#pega_programação').html(data);
                        }
                    })
                }
...
<section class="tudo">
  <div class="container">
  <div class="row">
    <div class="col-md-8 letra">
      <span class="letrao"><?php echo $numeror ?></span>
      <img class="festivalit img-fluid" src="../../dist/img/festivalit.png" alt="Festival Itinerante de Leitura">
    ...
    <div class="col-md-7">
      <div class="row">
        <div class="col-md-12">
          ...
          <img src="../../dist/img/pipav1b.png" class="img-fluid float-right">
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
  ...
  <div class="row">
    ...
    if($resultado_id){
      ...
      echo "<a target='__blank' href='$link'>";
        ...
        echo "<p align='center' class='texto_button33'>$nome</p>";
        echo "</div>";
          echo "</a>";
      echo "</div>";
